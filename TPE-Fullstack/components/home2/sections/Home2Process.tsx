...
import { ProcessAnimatedIcon } from "./ProcessAnimatedIcons";
          ...
          {content.steps.map((step) => (
            <li key={step.id} className="home2-process__step">
              ...
              <div className="home2-process__step-top">
                <div className="home2-process__icon-badge">
                  <ProcessAnimatedIcon id={step.id} />
                </div>
                <div className="home2-process__step-meta">
                  <span className="home2-process__index">{step.index}</span>
                  <span className="home2-process__phase">Benefit {step.index}</span>
                </div>
              </div>
